  ...
  return (
    <div className='bg-cyan-900 text-white rounded-lg px-4 py-2 m-4 relative hover:shadow-xl'>
      ...
      <div className='flex justify-between items-center gap-x-2 mt-4 p-4'>
        <BiShow className='text-3xl text-blue-600 hover:text-blue-900 cursor-pointer' onClick={() => setShowModal(true)} />
        <Link to={`/books/details/${book._id}`} className='text-green-600 hover:text-green-900'>
          <BsInfoCircle className='text-2xl' />
        </Link>
        <Link to={`/books/edit/${book._id}`} className='text-yellow-600 hover:text-yellow-900'>
