...
const EditBook = () => {
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-8 font-bold text-blue-900 text-center'>Update Book</h1>
      {loading ? <Spinner /> : ''}
      ...
      <div className='bg-cyan-900 flex flex-col rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <button className='p-2 bg-cyan-300 mt-8 font-bold text-blue-900 hover:bg-cyan-600 hover:text-white' onClick={handleEditBook}>Update</button>
